...
var songList = ["middle child","project dreams","slime believer"];
...
var classList = ["rickey","andrew","tianna","chenai"];
...
var teacherList = ["joel","liann","riley","attardi"];
...
var familyAges = ["15","14","12","7"];
console.log(familyAges[0]);
